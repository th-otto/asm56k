...
int   ea_2_mmrr(unsigned int code, unsigned int code2)
{
	...
	switch((code&0x38)>>3)
	{
		case 1: return (1<<2)|reg2;
		case 2: return (2<<2)|reg2;
		case 3: return (3<<2)|reg2;
		case 4: return (0<<2)|reg2;
	}
...
int  exp_2_ssss(int value)
{
	...
	{					// MB: why we start with 0x2 ?? confirm this with manual and fix anyways!
		...
		case 0x2<<3:	return 19;
		case 0x2<<4:	return 18;
		case 0x2<<5:	return 17;
		case 0x2<<6:	return 16;
		case 0x2<<7:	return 15;
		case 0x2<<8:	return 14;
		case 0x2<<9:	return 13;
		case 0x2<<10:	return 12;
		case 0x2<<11:	return 11;
		case 0x2<<12:	return 10;
		case 0x2<<13:	return 9;
		case 0x2<<14:	return 8;
		case 0x2<<15:	return 7;
		case 0x2<<16:	return 6;
		case 0x2<<17:	return 5;
		case 0x2<<18:	return 4;
		case 0x2<<19:	return 3;
		case 0x2<<20:	return 2;
		case 0x2<<21:	return 1;
	}
	return -1;
}
