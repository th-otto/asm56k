...
void EvalCondition(uint condition,Value val1,Value val2)
{
	...
	switch(condition)
	{
		break; case EQUAL:              answer = Val_Eq(val1,val2);
		break; case NOT_EQUAL:          answer = !Val_Eq(val1,val2);
		break; case SMALLER:            answer = Val_Ls(val1,val2);            
		break; case BIGGER:             answer = Val_Ls(val2,val1);
		break; case SMALLER_OR_EQUAL:   answer = Val_Ls(val1,val2) || Val_Eq(val1,val2) ;           
		break; case BIGGER_OR_EQUAL:    answer = Val_Ls(val2,val1) || Val_Eq(val1,val2) ;
	}
...
void GenIfError()
{
	PASS1 yyerror("Illegal condition.");
	PASS2 PASSEND
