...
LIBDIRS_ARG=$(foreach libdir,$(LIB_DIRS),-I$(ROOTDIR)/$(libdir) )
...
define compile_cpp_o_template
	...
	@$(CPP) $(INCDIRS_ARG) $(DEFS_ARG) -M $(1)  -MT $(2) | sed 's/$(2):/$(2)=/' > $(CACHEDIR)/$(notdir $(basename $(1))).d
	@$(CPP) -c $(INCDIRS_ARG) $(DEFS_ARG) $(CPPFLAGS) -o $(CACHEDIR)/$(notdir $(basename $(1))).o $(1)	
endef
...
define compile_c_o_template
	@echo [$(BUILDNAME)] compiling $(notdir $(1))
	@$(CC) $(INCDIRS_ARG) $(DEFS_ARG) -M $(1)  -MT $(2) | sed 's/$(2):/$(2)=/' > $(CACHEDIR)/$(notdir $(basename $(1))).d
	@$(CC) -c $(INCDIRS_ARG) $(DEFS_ARG) $(CFLAGS) -o $(CACHEDIR)/$(notdir $(basename $(1))).o $(1)
endef
